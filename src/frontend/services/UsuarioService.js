...
class UsuarioService {
    ...
    static async publicarMateria(titulo, tema, materia, arquivo, idProfessor) {
        return axios.post(`${API_URL}/materias/publicar`, { titulo, tema, materia, arquivo, idProfessor });
    }

    // Progresso
    static async atualizarProgresso(idUsuario, atividadeId, titulo, tema, materia, progresso) {
        return axios.post(`${API_URL}/materias/progresso`, { idUsuario, atividadeId, titulo, tema, materia, progresso });
    }

    static async listarProgressoUsuario(idUsuario, materia) {
        return axios.get(`${API_URL}/materias/progresso/${idUsuario}/${encodeURIComponent(materia)}`);
    }
